...
<template>
    ...
    <div class="mx-auto max-w-5xl px-4 py-6 sm:px-6 lg:px-8">
        ...
        <p class="mt-1 text-gray-500">{{ t('blog.subtitle') }}</p>
        ...
        >
            ...
            >
                <div class="aspect-[16/9] w-full overflow-hidden bg-gray-100">
                    ...
                    <div
                        v-else
                        class="flex h-full w-full items-center justify-center bg-gradient-to-br from-blue-50 to-blue-100 text-blue-300"
                    >
                ...
                <div class="flex flex-1 flex-col p-5">
                    ...
                    <h2
                        class="mt-1 text-lg font-semibold text-gray-900 group-hover:text-blue-600"
                    >
                        {{ post.title }}
                    </h2>
                    <p
                    ...
                    <span
                        class="mt-4 inline-flex items-center gap-1 text-sm font-semibold text-blue-600"
                    >
        ...
        <p v-else class="mt-10 text-center text-gray-400">
            {{ t('blog.empty') }}
        </p>
    </div>
</template>
